...
public class LuaLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"T__0", "ALPHA", "DIGIT", "ID", "POSITIVE", "INT", "EXPONENT", "FLOAT", 
			"STRING", "NAME", "END", "FUNCTION", "SEMI", "ADD", "SUB", "MULT", "DIV", 
			"EQ", "FDIV", "ASSIGN", "AND", "OR", "NOT", "IF", "THEN", "ELSEIF", "ELSE", 
			"TRUE", "FALSE", "LP", "RP", "LB", "RB", "LK", "RK", "DOT", "COMMA", 
			"COLON", "CONCAT"
		};
	}
